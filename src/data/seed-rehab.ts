...
export const SEED_REHAB: readonly SeedNote[] = [
  ...
  },
  {
    ...
    group: "lower",
    slug: "adductors",
    title: "Adductors and groin",
    subtitle: "Pulled something on a wide step?",
    note: "Groin strains happen to the adductor when it is long and loaded — a lunge sideways, a change of direction. Strength through that range is what prevents the next one.",
    exercises: [
      { name: "Copenhagen plank", note: "Side plank, top foot on a bench, lift the bottom leg to meet it. The single best one here. 3 sets of 8 a side." },
      { name: "Short lever Copenhagen", note: "Same thing with the top knee on the bench instead of the foot. Start here. 3 sets of 10." },
      { name: "Adductor squeeze", note: "Ball between the knees, squeeze 30 seconds. Calms an irritated groin and you can do it daily. 5 rounds." },
      { name: "Side-lying adduction", note: "Top leg crossed over, lift the bottom leg. Slow. 3 sets of 15 a side." },
      { name: "Cossack squat", note: "Loads the adductor at full length. Bodyweight first, hold a plate later. 3 sets of 6 a side." },
      { name: "Slider adduction", note: "Foot on a slider, let it slide out, pull it back in under control. 3 sets of 10." },
      { name: "Wide stance goblet squat", note: "Adductor work inside a lift you already do. 3 sets of 10." },
    ],
  },
  {
    category: "rehab",
  ...
  },
  {
    ...
    title: "Shins and tibialis",
    subtitle: "Shins burning when you run?",
    caution: "Shin pain that stays sharp in one spot, hurts at night, or gets worse week on week is worth having looked at rather than trained through.",
    note: "Shin splints are usually load going up faster than the front of the lower leg can take. Building it, and backing the mileage off for a fortnight, generally fixes it.",
    exercises: [
      { name: "Tibialis raise", note: "Back against a wall, heels a step out, lift the toes. The staple. 3 sets of 25." },
      { name: "Banded dorsiflexion", note: "Band round the forefoot, pull the foot up against it. 3 sets of 20 a side." },
      { name: "Heel walk", note: "Walk on your heels with the toes lifted. 3 lengths." },
      { name: "Eccentric toe lower", note: "Toes up fast, down over five seconds. Where the strength comes from. 3 sets of 12." },
      { name: "Seated toe tap", note: "Heels down, tap the toes fast for 60 seconds. Endurance rather than strength." },
      { name: "Weighted tibialis raise", note: "Once bodyweight is easy, hook a plate or a kettlebell over the toes. 3 sets of 15." },
      { name: "Soleus calf raise", note: "The back of the lower leg shares the load. Bent knee, slow. 3 sets of 15." },
    ],
  },
  {
    category: "rehab",
